...
//             CI: Serialize + DeserializeOwned + Debug + Clone + ConciseSerde,
//     {
//         self.mutate_with_vm_slots_ptable(state, None)
//     }
//
...
//                             let index: usize = state.rand_mut().next() as usize % data_len;
//                             let result = aarray.data[index].mutate_with_vm_slots_ptable(state, vm_slots);
//                             return result;
//                         }
...
//                 } else {
//                     let index: usize = state.rand_mut().next() as usize % data_len;
//                     return aarray.data[index].mutate_with_vm_slots_ptable(state, vm_slots);
//                 }
//                 MutationResult::Mutated
//             }
//             // mutate unknown args, may change the type
